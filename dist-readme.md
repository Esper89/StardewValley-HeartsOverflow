...
To install this mod, place the `Hearts Overflow` folder (containing `manifest.json`) in your [SMAPI]
`Mods` folder. You may also want to install [Generic Mod Config Menu][GMCM] and [GMCM Options] to
configure this mod.
...
This mod's source code and documentation can be found in its [GitHub repository][repo].
